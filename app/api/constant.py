...
class GrpColumns:
    ...
    CORR_COLS = [
        ...
        "parking_features_attachedcarport",
        "parking_features_attachedgarage",
        "parking_features_nan",
        "road_responsibility_nan",
        "roof_nan",
        "security_features_nan",
        "building_features_deliverydoor",
        "building_features_fixedfurniture",
        "building_features_frontelevation",
        "building_features_loadingdock",
        "building_features_nan",
        "sewer_septicinstalled",
        "view_golfcourse",
        "view_water",
        "window_features_displaywindows",
        "window_features_nan",
        ...
        "car_hoa_subject_to_Required",
        "postal_code_enc",
        "high_school_enc",
        "middle_or_junior_school_enc",
    ]
